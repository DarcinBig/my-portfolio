...
const Contact = () => {
  ...
  return (
    <Reveal initialY={40} delay={0.5}>
      <section ref={ref} id='contact' className='card relative items-center mx-6 flex flex-col px-[33px] py-[27px] z-30 gap-[54px] md:gap-[35px] mb-[67px] md:mb-[42px] group overflow-hidden'>
